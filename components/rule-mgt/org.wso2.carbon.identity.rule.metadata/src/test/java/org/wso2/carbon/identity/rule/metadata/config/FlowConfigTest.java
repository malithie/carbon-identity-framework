...
import org.wso2carbon.identity.rule.metadata.config.FlowConfig;
...
import org.wso2carbon.identity.rule.metadata.model.Field;
...
import org.wso2carbon.identity.rule.metadata.model.Link;
import org.wso2carbon.identity.rule.metadata.model.Operator;
...
import org.wso2carbon.identity.rule.metadata.model.OptionsValue;
...
public class FlowConfigTest {
    ...
    public void setUpClass() throws RuleMetadataConfigException {
        ...
        String filePath = Objects.requireNonNull(getClass().getClassLoader().getResource(
                ...
                .getFile();
        OperatorConfig operatorConfig = OperatorConfig.load(filePath);
        ...
        fieldDefinitionMap = getMockedFieldDefinitions();
        when(fieldDefinitionConfig.getFieldDefinitionMap()).thenReturn(fieldDefinitionMap);
    }
    ...
    public void testLoadFieldDefinitionsForFlowFromValidConfig() throws Exception {
        ...
        String flowsFilePath = Objects.requireNonNull(getClass().getClassLoader().getResource(
                        "configs/valid-flows.json"))
                .getFile();
        FlowConfig flowConfig = FlowConfig.load(flowsFilePath, fieldDefinitionConfig);
        ...
        assertEquals(result,
                Arrays.asList(fieldDefinitionMap.get("application"), fieldDefinitionMap.get("grantType")));
    }
    ...
    public Object[][] invalidConfigFiles() {
        ...
        return new Object[][]{
//                {getClass().getClassLoader().getResource("configs/invalid-flows-unregistered-flow.json").
//                        getFile()},
                {getClass().getClassLoader().getResource("configs/invalid-flows-unregistered-field.json").
                        getFile()},
//                {"unavailable-file.json"}
    ...
    public void testLoadFieldDefinitionsForFlowFromInvalidConfig(String filePath) throws RuleMetadataConfigException {
        ...
        FlowConfig.load(filePath, fieldDefinitionConfig);
    }
