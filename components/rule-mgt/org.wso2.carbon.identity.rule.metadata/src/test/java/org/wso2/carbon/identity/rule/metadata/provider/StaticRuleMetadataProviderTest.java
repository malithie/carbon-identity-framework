...
import org.wso2carbon.identity.rule.metadata.provider.impl.StaticRuleMetadataProvider;
...
public class StaticRuleMetadataProviderTest {
    ...
    @Test(expectedExceptions = RuleMetadataServerException.class, expectedExceptionsMessageRegExp = "Error while loading static rule metadata.")
    public void testLoadStaticMetadataThrowsException() throws RuleMetadataServerException {
        ...
        try (MockedStatic<RuleMetadataConfigFactory> ruleMetadataConfigFactoryMockedStatic = mockStatic(
            ...
            ruleMetadataConfigFactoryMockedStatic.when(
                            () -> RuleMetadataConfigFactory.load(anyString(), anyString(), anyString()))
