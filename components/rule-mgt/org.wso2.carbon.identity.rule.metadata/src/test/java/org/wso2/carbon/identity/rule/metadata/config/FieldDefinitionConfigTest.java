...
import org.wso2carbon.identity.rule.metadata.config.FieldDefinitionConfig;
import org.wso2carbon.identity.rule.metadata.config.OperatorConfig;
...
import org.wso2carbon.identity.rule.metadata.model.InputValue;
import org.wso2carbon.identity.rule.metadata.model.OptionsInputValue;
import org.wso2carbon.identity.rule.metadata.model.OptionsReferenceValue;
import org.wso2carbon.identity.rule.metadata.model.Value;
...
public class FieldDefinitionConfigTest {
    ...
    public void setUpClass() throws RuleMetadataConfigException {
        ...
        String filePath = Objects.requireNonNull(getClass().getClassLoader().getResource(
                ...
                .getFile();
        operatorConfig = OperatorConfig.load(filePath);
    ...
    public void testLoadFieldDefinitionsFromValidConfig() throws RuleMetadataConfigException {
        ...
        FieldDefinitionConfig fieldDefinitionConfig = FieldDefinitionConfig.load(filePath, operatorConfig);
    ...
    public Object[][] invalidConfigFiles() {
        ...
        return new Object[][]{
                {getClass().getClassLoader().getResource("configs/invalid-fields-missing-field-name.json").getFile()},
                {getClass().getClassLoader().getResource("configs/invalid-fields-missing-field-displayname.json")
                        .getFile()},
                {getClass().getClassLoader().getResource("configs/invalid-fields-unregistered-operator.json")
                        .getFile()},
                {getClass().getClassLoader().getResource("configs/invalid-fields-invalid-input-type.json")
                        .getFile()},
                {getClass().getClassLoader().getResource("configs/invalid-fields-invalid-value-type.json")
                        .getFile()},
                {getClass().getClassLoader()
                        .getResource("configs/invalid-fields-missing-value-reference-attribute.json")
                        .getFile()},
                {getClass().getClassLoader().getResource("configs/invalid-fields-missing-value-display-attribute.json")
                        .getFile()},
                {getClass().getClassLoader().getResource("configs/invalid-fields-missing-links.json")
                        .getFile()},
                {getClass().getClassLoader().getResource("configs/invalid-fields-missing-link-href.json")
                        .getFile()},
                {getClass().getClassLoader().getResource("configs/invalid-fields-missing-link-method.json")
                        .getFile()},
                {getClass().getClassLoader().getResource("configs/invalid-fields-missing-link-rel.json")
                        .getFile()},
                {getClass().getClassLoader().getResource("configs/invalid-fields-missing-values.json")
                        .getFile()},
    ...
    public void testLoadFieldDefinitionsFromInvalidConfig(String filePath) throws RuleMetadataConfigException {
        ...
        FieldDefinitionConfig.load(filePath, operatorConfig);
    }
}
