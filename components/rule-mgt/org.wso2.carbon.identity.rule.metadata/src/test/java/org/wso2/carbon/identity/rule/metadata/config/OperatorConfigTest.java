    ...
    public Object[][] invalidConfigFiles() {
        ...
        return new Object[][]{
                {getClass().getClassLoader().getResource(
                        "configs/invalid-operators-missing-operator-name.json").getFile()},
                {getClass().getClassLoader().getResource("configs/invalid-operators-missing-operator-displayname.json")
                        .getFile()},
