...
public class FieldDefinitionConfig {
    ...
    public static FieldDefinitionConfig load(String filePath, OperatorConfig operatorConfig)
        ...
        try {
            ...
            Map<String, Map<String, Object>> configMap =
                    mapper.readValue(new File(filePath), typeFactory.constructMapType(
            ...
            throw new RuleMetadataConfigException("Error while loading field definitions from file: " + filePath, e);
        }
    }
