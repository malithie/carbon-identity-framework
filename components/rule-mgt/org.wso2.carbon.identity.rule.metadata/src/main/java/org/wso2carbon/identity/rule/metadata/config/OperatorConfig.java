...
public class OperatorConfig {
    ...
    public static OperatorConfig load(String filePath) throws RuleMetadataConfigException {
        ...
        try {
            ...
            throw new RuleMetadataConfigException("Error while loading operators from file: " + filePath, e);
        }
    }
}
